...
class TwoNumberSumTest {
    ...
    void whenTwoEqualsNumbersYesTarget() {
        int[] array = {5, 5};
        int target = 10;
        int[] result = TwoNumberSum.getIndexesCycle(array, target);
        int[] expected = {0, 1};
    ...
    @Test
    void whenTwoEqualsNumbersYesTargetWhile() {
        int[] array = {5, 5};
        int target = 10;
    ...
    @Test
    void whenTwoEqualsNumbersNoTargetWhile() {
        int[] array = {5, 5};
        int target = 12;
        int[] result = TwoNumberSum.getIndexes(array, target);
        int[] expected = {};
    ...
    @Test
    void whenWithNegativeNumbersYesTargetWhile() {
        int[] array = {-7, -5, 0, 5, 8, 12};
        int target = 3;
        int[] result = TwoNumberSum.getIndexes(array, target);
        int[] expected = {1, 4};
    ...
    @Test
    void whenWithoutNegativeNumbersYesTargetWhile() {
        int[] array = {0, 2, 5, 8, 10, 12};
        int target = 15;
        int[] result = TwoNumberSum.getIndexes(array, target);
        int[] expected = {2, 4};
